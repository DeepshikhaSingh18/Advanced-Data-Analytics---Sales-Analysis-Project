...
2. Segments products by revenue to identify high-perfomance, mid-range, or low performers.
...
WITH base_query AS(
/*
1. Base query - retrieves core columns from fact_saes and dim_products
*/
SELECT 
f.order_number,
f.order_date,
...
/*
2. Product Aggregation: Summarizes key metric at the product level
*/
SELECT
	product_key,
	product_name,
